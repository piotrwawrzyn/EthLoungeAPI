...
// Serialization string is needed to trick e-mail services that the mail is unique
const serializationString = randomstring.generate(5);
...
const verificationEmail = (permalink, verificationToken, username) => {
  ...
  <body>
    <table
      style="width:100%; margin: 0 auto; color: #1b1c1d; max-width: 600px; padding-top: 10px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif"
    >
      <tbody>
        <tr>
          <td>
        ...
        <tr>
          <td style="padding-top: 40px">
            <p style="font-weight: bold; color: #1b1c1d;">
              Never signed up at ethlounge?
            </p>
            <p style="color: #1b1c1d;">
    ...
    <span style="color: white; font-size: 0px">${serializationString}</span>
  </body>
</html>
    `;
};
